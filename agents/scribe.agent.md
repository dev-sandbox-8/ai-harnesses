...
Write a summary of all folders updated and files changed/added/removed to the file path
provided by the orchestrator (`agent-output/<id>.md`). Your primary deliverables are the
README.md files in each folder, but the orchestrator needs the summary to proceed.
